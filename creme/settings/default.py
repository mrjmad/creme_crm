# -*- coding: utf-8 -*-
# Django default settings for creme project.
...
CREME_ROOT = join(BASE_DIR, 'creme')  # BASE_DIR + '/creme'
...
GLOBAL_MEDIA_DIRS = [join(CREME_ROOT, 'static')]
...
YUICOMPRESSOR_PATH = join(
    CREME_ROOT, 'static', 'utils', 'yui', 'yuicompressor-2.4.2.jar',
)
CLOSURE_COMPILER_PATH = join(
    CREME_ROOT, 'static', 'utils', 'closure', 'closure-compiler-v20200112.jar',
)
