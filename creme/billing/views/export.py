...
from creme.creme_core.views.generic import CremeEditionPopup, base

from ..exporters import BillingExporterManager
from ..forms.export import ExporterConfigurationForm
...
class ExporterConfigEdition(base.EntityCTypeRelatedMixin, CremeEditionPopup):
    form_class = ExporterConfigurationForm
...
class Export(base.EntityRelatedMixin, base.CheckedView):
    ...
    def check_related_entity_permissions(self, entity: CremeEntity, user):
    ...
    def get(self, request, *args, **kwargs):
        ...
        exporter_id = config_item.exporter_id
        if not exporter_id:
        ...
        exporter = BillingExporterManager().exporter(
        ...
        return HttpResponseRedirect(
            exporter.export(entity=entity, user=request.user).get_download_absolute_url()
        )
